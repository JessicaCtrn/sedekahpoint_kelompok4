...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> registerUser() async {
    setState(() {
      usernameError = usernameController.text.isEmpty ? "Username wajib diisi" : null;
      phoneError = phoneController.text.isEmpty ? "No. Handphone wajib diisi" : null;
      emailError = emailController.text.isEmpty ? "Email wajib diisi" : null;
